...
const Navbar = () => {
    ...
    return (
        <>
            <nav className='fixed top-0 left-0 right-0 w-full bg-white/95 backdrop-blur-sm shadow-lg' style={{ zIndex: 9999 }}>
            ...
            {show && (
                <>
                    ...
                    <div
                        className='md:hidden fixed  left-0 right-0 bottom-0 bg-white overflow-y-auto'
                        style={{ zIndex: 9998 }}
                    >
